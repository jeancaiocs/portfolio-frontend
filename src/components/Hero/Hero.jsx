...
const HeroModerno = () => {
  return (
    <section className="hero-moderno" id="home">
    ...
    />
        ...
        <div className="hero-moderno-content">
          ...
          <h1 className="hero-name">
            Jean Caio
            <br />
            <span className="hero-surname gradient-text">Casagrande</span>
          </h1>
          ...
          <p className="hero-bio">
            Especializado em React, JavaScript e interfaces modernas. Buscando minha primeira 
            oportunidade para transformar código em experiências incríveis.
          </p>
          
          <div className="hero-buttons-moderno">
            <a 
